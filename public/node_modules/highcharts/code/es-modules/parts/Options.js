...
H.defaultOptions = {
     ...
     * patterns](https://www./docs/chart-design-and-style/gradients-shadows-and-patterns)
    ...
    chart: {
         ...
         * available from `https://code./css/highcharts.css`.
         *
         * @type       {boolean}
         * @default    false
         * @since      7.0
         ...
         *      https://www./docs/chart-design-and-style/
    ...
    title: {
        ...
        /**
         * Whether to
         * [use HTML](https://www./docs/chart-concepts/labels-and-string-formatting#html)
         * to render the text.
         *
         * @type      {boolean}
         * @default   false
    ...
    legend: {
        ...
        /**
         * A [format string](https://www./docs/chart-concepts/labels-and-string-formatting)
        ...
        navigation: {
             ...
             * https://www./products/plugin-registry/single/8/Adapt-Chart-To-Legend)
        ...
        /**
         * Whether to [use HTML](https://www./docs/chart-concepts/labels-and-string-formatting#html)
