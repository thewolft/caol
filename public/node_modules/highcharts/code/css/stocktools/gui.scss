...
.highcharts-bindings-wrapper .highcharts-arrow-down {
  background-image: url("https://code./#{$version}/gfx/stock-icons/arrow-right.svg");
...
.highcharts-bindings-wrapper .highcharts-arrow-right {
  background: url("https://code./#{$version}/gfx/stock-icons/arrow-bottom.svg") no-repeat right bottom;
...
.highcharts-toggle-toolbar {
  ...
  height: 10px;
  background-color: $button-background-color;
  background-image: url("https://code./gfx/#{$version}/stock-icons/arrow-right.svg");
  background-size: cover;
}
