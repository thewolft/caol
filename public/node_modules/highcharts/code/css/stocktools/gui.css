...
.highcharts-bindings-wrapper .highcharts-arrow-down {
  background-image: url("https://code./7.0.3/gfx/stock-icons/arrow-right.svg");
...
.highcharts-bindings-wrapper .highcharts-arrow-right {
  background: url("https://code./7.0.3/gfx/stock-icons/arrow-bottom.svg") no-repeat right bottom;
...
.highcharts-toggle-toolbar {
  ...
  height: 10px;
  background-color: #f7f7f7;
  background-image: url("https://code./gfx/7.0.3/stock-icons/arrow-right.svg");
  background-size: cover;
}
