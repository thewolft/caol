...
(function (factory) {
    ...
    (function (H) {
         ...
         * https://api./highcharts/chart.scrollablePlotArea) option that
    ...
    (function (H) {
         ...
         *        [options reference](https://api./highstock).
         *
         ...
         *        [chart.events.load](https://api./highstock/chart.events.load)
         ...
         * [compare](https://api./highstock/plotOptions.series.compare)
         ...
         * after render time.
         *
         * @see [series.plotOptions.compare](https://api./highstock/series.plotOptions.compare)
         *
